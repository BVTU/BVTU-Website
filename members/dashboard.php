    ...
    <div class="container">
      ...
      <div class="doc-section" style="margin-bottom:1.5rem;">
        ...
        <div class="doc-list">
          ...
          <a href="invite-manage.php" class="doc-item">
            <svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/><line x1="12" y1="19" x2="12" y2="13"/><line x1="9" y1="16" x2="15" y2="16"/></svg>
            Member Invitations
          </a>
          <?php endif; ?>
