  ...
  <main class="page-content">
    <div class="container">
      ...
      <div class="lp-quickbar">
        <span class="lp-quickbar-label">Expenses &amp; Grants</span>
      ...
      <div class="doc-section" style="margin-bottom:1.5rem;">
        ...
        <div class="doc-list">
          ...
          <?php endif; ?>
          <!-- Expense Portal Admin retired: its only action duplicated Member Management. -->
        </div>
      </div>
      <?php $expenseSection = ob_get_clean(); ?>

      <?php
        // Signers live in this section, so it leads for them; everyone else
        // sees it in its usual place further down.
        $isSigner = execIsAdmin($myEmail) || expIsVP($myEmail) || expIsTreasurerRole($myEmail);
        if ($isSigner) echo $expenseSection;
      ?>
      <!-- Pro-D Portal hidden until it is ready to launch. -->
      ...
      <!-- EC Mileage retired: mileage is claimed on the standard expense form,
           so it goes through the same two signatures as every other claim. -->


      <?php if (!$isSigner) echo $expenseSection; ?>

      <div class="doc-section" style="margin-bottom:1.5rem;">
        <h2>My Account</h2>
        <div class="doc-list">
          <a href="my-account.php" class="doc-item">
      ...
      <div class="doc-section" style="margin-bottom:1.5rem;">
        ...
        <div class="doc-list">
          <?php if (execIsAdmin($myEmail)): ?>
          <a href="people.php" class="doc-item">
          ...
          <?php if (execIsAdmin($myEmail)): ?>
          <a href="email-templates.php" class="doc-item">
          ...
          <a href="bctf-forms.php" class="doc-item">
            ...
            <?php
              ...
              if ($bctfPending > 0): ?>
            <span class="lock-badge"><?= $bctfPending ?> ready to send</span>
            <?php endif; ?>
          </a>
          <a href="onedrive.php" class="doc-item">
            <svg viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
            OneDrive Doc Upload
          </a>
          <a href="links-manage.php" class="doc-item">
